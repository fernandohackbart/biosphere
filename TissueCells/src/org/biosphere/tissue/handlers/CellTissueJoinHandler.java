...
public class CellTissueJoinHandler implements CellHTTPHandlerInterface
{
  ...
  public void handle(HttpExchange t)
  {
    try
    {
      ...
      logger.info("CellTissueJoinHandler.handle()", "Adding local cell to the local DNA (just in case the adopter forgot");
      ...
      os.close();
      logger.info("CellTissueJoinHandler.handle()", "Joined tissue: " + getCell().getCellDNA().getTissueName() + " from: " + partnerCell);
    }
    catch (IOException e)
    {
    ...
    //{
    //  ExceptionHandler.handleGenericException(e,"CellTissueJoinHandler.handle()","CertificateEncodingException | KeyStoreException:");
    //}

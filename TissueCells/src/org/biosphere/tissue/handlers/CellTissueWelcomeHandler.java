  ...
  public void handle(HttpExchange t)
  {
    try
    {
      ...
      if (requestPayload.startsWith("WLCM:"))
      {
        ...
        logger.debug("CellTissueWelcomeHandler.handle()", "Welcome request to tissue " + requestTissue+" from cell:"+requestCell);
        ...
        {
          TissueExceptionHandler.handleGenericException(e,"CellTissueWelcomeHandler.handle()","CertificateEncodingException/KeyStoreException:");
        }
        catch (CertificateException e)
        {
          TissueExceptionHandler.handleGenericException(e,"CellTissueWelcomeHandler.handle()","CertificateException:");
        }                
      }

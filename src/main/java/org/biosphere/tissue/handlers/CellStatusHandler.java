...
public class CellStatusHandler extends AbstractHandler {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		responseSB.append("##############################################################################\n");
		responseSB.append("Tissue name: " + getCell().getDna().getTissueName() + "\n");
		responseSB.append("Tissue size: " + getCell().getDna().getTissueSize() + "\n");
		responseSB.append("##############################################################################\n");
		...
		while (ciitJSON.hasNext()) {
			...
			responseSB.append("  Tissue cell: " + cif.getCellName() + "(" + cif.getCellNetworkName() + ":"
					+ cif.getPort() + ")\n");
		}
		responseSB.append("##############################################################################\n");
		...
		responseSB.append("##############################################################################\n");
		responseSB.append("Log level: trace=" + getLogger().isTraceEnabled() + " debug=" + getLogger().isDebugEnabled()
				+ " info=" + getLogger().isInfoEnabled() + " warn=" + getLogger().isWarnEnabled() + " error="
				+ getLogger().isErrorEnabled() + "\n");
		responseSB.append("Log level: " + TissueManager.logLevelParameter + "="
				+ System.getProperty(TissueManager.logLevelParameter) + "\n");
		responseSB.append("Log level: " + TissueManager.logOutputParameter + "="
				+ System.getProperty(TissueManager.logOutputParameter) + "\n");
		responseSB.append("Log level: " + TissueManager.logShowDateTimeParameter + "="
				+ System.getProperty(TissueManager.logShowDateTimeParameter) + "\n");
        //TODO filter by type of information
		//if (request.getParameter("item").equals("chain")) {
		//}
		responseSB.append("##############################################################################\n");
